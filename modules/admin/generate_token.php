...
$input.clockpicker('hidden');
  ...
  <script>
      ...
      {
        var fields= ' <div class="wrapper" id="reservation_wrapper"><div class="row"><div class="col"><label>Name</label><br><input type="text" name="traveler[0][]"></div><div class="col"><label>Age</label><br><input type="text" name="traveler[1][]"></div><div class="col"><label>Gender</label><br><select name="traveler[2][]"><option value="1">Male</option><option value="2">Female</option><option value="3">Other</option></select></div></div><div class="row"><div class="col"><label>ID Type</label><input type="text" name="traveler[3][]"></div><div class="col"><label>ID Number</label><input type="text" name="traveler[4][]"></div><div class="col"><label>Contact Number</label><input type="text" name="traveler[5][]"></div></div></div>';
        $("#test").append(fields);        
      }
    </script>