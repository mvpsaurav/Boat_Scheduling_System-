...
if($confirm_password==$password)
{
  ...
  {
    // header("location: ../../modules/bo/bo_listing.php");
    echo "account was successfully created please wait for verification";
  }
}
else
{
	//  echo"password did not match";
    header("location: ../../modules/bo/register.php?error=password_did_not_match");
}
