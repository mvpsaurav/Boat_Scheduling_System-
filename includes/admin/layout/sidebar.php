...
<ul class="list-group sidebar_list sidebar_list">
	...
	<a href="#"><li class="">Boat Registration</li></a>
	<a href="#"><li class="">Generate Token</li></a>
	<a href="#"><li class="">Token History</li></a>
	<a href="../../modules/logout.php"><li class="">Logout</li></a>
</ul>
</div>